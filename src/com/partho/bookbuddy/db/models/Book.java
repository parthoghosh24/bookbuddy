...
public class Book implements Parcelable{
	...
	private ArrayList<Manifest> manifestList = new ArrayList<Manifest>();
	...
	{
		String[] bookDataArray = new String[14];
	...
	{
		return this._id+" "+this.author+" "+this.title+" "+this.cssPath+" "+this.categoryId+" "+this.publisher+" "+this.date+" "+this.fileName+" "+this.opfFileName;
	}
